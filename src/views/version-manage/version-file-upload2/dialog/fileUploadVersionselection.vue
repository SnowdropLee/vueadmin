...
import versionIsExist from "@/message/version/versionFileUpload2/version-is-exist";
import versionFileUpload from "@/message/version/versionFileUpload2/version-file-upload";
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        mainVersionCode:[
          { required: true, message: "请选择主版本号", trigger: "change" }
        ]
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          resBody.data.mainVersionCode = this.form.mainVersionCode;
