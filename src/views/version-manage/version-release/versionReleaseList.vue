  ...
  <div v-loading="loading" element-loading-text="拼命加载中">
    ...
    <el-card>
      ...
      <el-table border class="tableMarginTop" :data="tableData" header-row-class-name="tableHeaderClass">
        ...
        <el-table-column prop="versioncode" label="版本编号" min-width="140" align="center"></el-table-column>
        ...
        <el-table-column align="center" fixed="right" label="操作" width="120" prop="versionstatus">
